...
import { k as Route$5, $ as useNavigate, X, P as Plus, Q as supabase } from "./_ssr/router-BWVHQLZp.mjs";
import { I as ImageUpload } from "./_ssr/ImageUpload-G5NlvZKx.mjs";
...
import "./_ssr/createSsrRpc-OYTRBK8B.mjs";
const CATEGORIES = [{
  value: "Camisetas",
  label: "Camisetas"
}, {
