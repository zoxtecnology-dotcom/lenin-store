...
import { h as Route$5, D as supabase } from "./_ssr/router-BAT9GkoO.mjs";
...
function EditarProducto() {
  ...
  reactExports.useEffect(() => {
    async function load() {
      const [{
        ...
        data: colorCatalog
      }] = await Promise.all([supabase.from("products").select("*, product_images(*), product_colors(*), product_variants(*)").eq("id", id).single(), supabase.from("colors").select("name, swatch").order("name")]);
      if (!p) {
        navigate({
          to: "/admin/productos"
        });
  ...
  function set(key, value) {
    ...
    if (key === "type") setProductType(value);
  }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8 max-w-3xl", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Section, { title: "Información básica", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Categoría", children: /* @__PURE__ */ jsxRuntimeExports.jsx("select", { value: form.category, onChange: (e) => set("category", e.target.value), className: input, children: CATEGORIES.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { children: c }, c)) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Tipo", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { value: form.type, onChange: (e) => set("type", e.target.value), className: input, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "standard", children: "Estándar" }),
    ...
    form.type === "conjunto" && /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { title: "Configuración del conjunto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
