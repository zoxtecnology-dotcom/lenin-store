...
import { a1 as useSettings, L as Link } from "./router-BWVHQLZp.mjs";
import { I as Instagram, S as SiteHeader, F as Footer } from "./Footer-DFgriNjy.mjs";
import { R as Reveal } from "./Reveal-BJbI2hXw.mjs";
import { M as Mail } from "./mail-BjQdESy-.mjs";
import { M as MessageCircle } from "./message-circle-sp0dcsBv.mjs";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-24 md:py-32 border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-[1500px] px-5 md:px-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-12 gap-10 md:gap-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Reveal, { className: "md:col-span-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-6 text-sm leading-relaxed text-cream/55", children: [
          ...
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: `mailto:${settings.email_contacto}`, className: "text-cream underline underline-offset-4 hover:text-acid transition-colors", children: settings.email_contacto }),
          " ",
