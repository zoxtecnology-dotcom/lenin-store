import { Y as reactExports, N as jsxRuntimeExports, O as Outlet } from "./index.mjs";
import { U as useAuth, $ as useNavigate, L as Link, t as cn, X, Q as supabase, x as createLucideIcon } from "./router-Cd0oBxWL.mjs";
import { u as useRouterState, M as Menu } from "./menu-BYb1-akj.mjs";
import { P as Package } from "./package-Dl87lcow.mjs";
import { S as ShoppingBag } from "./shopping-bag-6dSKfxZg.mjs";
import { U as Users } from "./users-uvBjjpaz.mjs";
...
const Box = createLucideIcon("box", __iconNode$6);
const __iconNode$5 = [
...
function AdminLayout() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-foreground flex", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "hidden md:flex flex-col fixed inset-y-0 left-0 bg-background border-r border-border z-40", style: {
      width: "var(--sidebar-w)"
    }, children: [
    ...
    sidebarOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed inset-0 z-50 md:hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "absolute left-0 top-0 bottom-0 bg-background border-r border-border flex flex-col", style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col min-h-screen admin-content", children: [
